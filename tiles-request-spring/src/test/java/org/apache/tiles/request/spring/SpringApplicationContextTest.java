...
public class SpringApplicationContextTest {
    ...
    public void testGetResource() throws IOException {
        UrlResource resource1 = new UrlResource(getClasspathUrl("resource1.xml"));
        UrlResource resource2 = new UrlResource(getClasspathUrl("resource2.xml"));
        UrlResource resource1English = new UrlResource(getClasspathUrl("resource1_en.xml"));
        UrlResource resource1Italy = new UrlResource(getClasspathUrl("resource1_it_IT.xml"));
    ...
    private URL getClasspathUrl(String filename) {
        try {
            return getClass().getClassLoader().getResource(filename).toURI().toURL();
        } catch (Exception e) {
